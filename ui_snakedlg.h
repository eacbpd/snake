...
public:
    ...
    void setupUi(QDialog *SnakeDlg)
    {
        if (SnakeDlg->objectName().isEmpty())
            SnakeDlg->setObjectName(QStringLiteral("SnakeDlg"));
        SnakeDlg->resize(510, 510);
        verticalLayout = new QVBoxLayout(SnakeDlg);
        verticalLayout->setSpacing(6);
        verticalLayout->setContentsMargins(11, 11, 11, 11);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        m_labscoreboard = new QLabel(SnakeDlg);
        m_labscoreboard->setObjectName(QStringLiteral("m_labscoreboard"));
        QPalette palette;
        ...
        m_frmAction->setObjectName(QStringLiteral("m_frmAction"));
    ...
    {
        SnakeDlg->setWindowTitle(QApplication::translate("SnakeDlg", "\350\264\252\351\243\237\350\233\207", 0));
